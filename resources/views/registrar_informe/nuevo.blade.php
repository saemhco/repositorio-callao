                     ...
                     <section>
                        <div class="row floating-labels mt-4">
                              ...
                              <div class="form-group col-md-3"> <!-- facultad -->
                                {!!Form::select('facultad',$facultades,1,['id'=>'fac','class'=>'form-control set_programa','data-modal'=>'nuevo'])!!}
                                <span class="bar"></span>
                                <label for="fac">Seleccione Facultad</label>
                              </div>
                              <div class="form-group col-md-3"> <!-- nivel académico -->
                                {!!Form::select('nivel_acad',$attr['tipo_programa']->pluck('descripcion','id'),1,['id'=>'nivel_acad','class'=>'form-control set_programa','data-modal'=>'nuevo'])!!}
                                <span class="bar"></span>
                        ...
                        <div class="row">
                           <div class="col-md-6 mt-4">
                              <div class="row">
                                 <div class="form-group col-md-4 col-sm-12">
                                    ...
                                    <input type="date" class="form-control" id="cronograma_inicio" name="cronograma_inicio">
                                 </div>
                                 <div class="form-group col-md-4 col-sm-12">
                                    <label for="cronograma_fin">Cronograma - Fin</label>
                                    <input type="date" class="form-control" id="cronograma_fin" name="cronograma_fin">
                                 </div>
                           ...
                           <div class="col-md-6 floating-labels mt-4">
                              <div class="row">
                                 ...
                                 <div class="form-group col-md-6">
                                    <input type="number" min="0" class="form-control" id="presupuesto" name="presupuesto" min="-1">
                                    </input>
                                    <span class="bar"></span>
                                 ...
                                 <div class="form-group col-md-6" id="otro_producto" style="display: none;">
                                    <input type="text" class="form-control" name="producto_otro">
                                    <span class="bar"></span>
